...
/**
 * Provides list of well known BLS variants with their associated algorithm name/identifier.
 */
public final class WellKnownAlgorithms {

    /**
     * The standard bls12-381 algorithm which uses the SHA-256 hashing algorithm.
