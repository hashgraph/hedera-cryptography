...
public final class BLS12381Group1Bindings {
	 ...
	 *
	 * @param output
	 * 		the byte array that will be filled with the new group element
	 ...
	 * @param output
	 * 		the byte array that will be filled with the quotient group element
	 * @return a non-zero error code if there was an error, otherwise 0
	 */
	 ...
	 * 		the second group element
	 * @param output
	 * 		the byte array that will be filled with the product group element
	 * @return a non-zero error code if there was an error, otherwise 0
	 */
	 ...
	 * 		the scalar exponent
	 * @param output
	 * 		the byte array that will be filled with the new result group element
	 * @return a non-zero error code if there was an error, otherwise 0
	 */
	 ...
	 * @param output
	 * 		the byte array that will be filled with the compressed group element
