...
public final class BLS12381Group1Bindings {
  private BLS12381Group1Bindings() {
    //		LibraryLoader.loadBundledLibrary(BLS12381Group1Bindings.class);
  }
  ...
  //	 *
  //	 * @return a byte array with byte 0 being an error code, and the remaining bytes representing
  ...
  //	 * @return a byte array with byte 0 being an error code, and the second byte representing the
  // equality of the input
  ...
  //	 * 		element. A value of 1 indicates a valid element, and a value of 0 indicates an invalid
  // element
  //	 */
  ...
  //	 */
  //	public static native byte[] g1Divide(final BLS12381Group1Element element1, final
  // BLS12381Group1Element element2);
  //
  //	/**
  ...
  //	 */
  //	public static native byte[] g1Multiply(final BLS12381Group1Element element1, final
  // BLS12381Group1Element element2);
  //
  //	/**
  ...
  //	 */
  //	public static native byte[] g1PowZn(final BLS12381Group1Element base, final
  // BLS12381FieldElement exponent);
  //
  //	/**
  ...
  static {
    //		final File test = new File(LibraryLoader.getLibraryPathInResources());
    //		final String abpath = test.getAbsolutePath();
    //		Native.register(BLS12381Group1Bindings.class,
    // "/Users/austinlittley/ws/hedera-bls-cryptography/src/main/resources/mac/aarch64/libpairings_jni_rust.dylib");
    LibraryLoader.loadBundledLibrary(BLS12381Group1Bindings.class);
    //		try {
    //
    //	NativeUtils.loadLibraryFromJar("/Users/austinlittley/ws/hedera-bls-cryptography/src/main/resources/mac/aarch64/libpairings_jni_rust.dylib");
    //		} catch (IOException e) {
    //			throw new RuntimeException(e);
    //		}
    //
    //	System.load("/Users/austinlittley/ws/hedera-bls-cryptography/src/main/resources/mac/aarch64/libpairings_jni_rust.dylib");
  }
}
