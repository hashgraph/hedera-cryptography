...
class BLS12381Group1BindingsTests {
	...
	void newRandomG1Unique() {
		...
		JNITestUtils.assertG1ElementNotEquals(randomElement1, randomElement2, "random elements shouldn't be equal");

		JNITestUtils.assertG1ElementNotEquals(randomElement1, JNITestUtils.getG1Identity(),
				"random element shouldn't equal identity");
		JNITestUtils.assertG1ElementNotEquals(randomElement2, JNITestUtils.getG1Identity(),
				"random element shouldn't equal identity");
	}

	@Test
	@DisplayName("newRandomG1 from same seed are equal")
	void newRandomG1Deterministic() {
		final Random random = RandomUtils.getRandomPrintSeed();
	...
	void g1DivideDeterministic() {
		...
		JNITestUtils.assertG1ElementEquals(
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1Divide(randomElement1, randomElement2)),
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1Divide(randomElement1, randomElement2)),
	...
	void g1MultiplyDeterministic() {
		...
		JNITestUtils.assertG1ElementEquals(
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1Multiply(randomElement1, randomElement2)),
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1Multiply(randomElement1, randomElement2)),
	...
	void multiplyNegatesDivide() {
		...
		JNITestUtils.assertG1ElementEquals(
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1Multiply(quotient, randomElement2)),
				randomElement1,
	...
	void g1PowZnDeterministic() {
		...
		JNITestUtils.assertG1ElementEquals(
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1PowZn(randomElement, randomScalar)),
				JNITestUtils.getG1ElementFromCall(BLS12381Group1Bindings.g1PowZn(randomElement, randomScalar)),
