...
class BLS12381GroupTests {
    ...
    void randomElementFromSeedUnique(final Group group) {
        ...
        Assertions.assertNotEquals(
                randomElement2, group.oneElement(), "random element 2 shouldn't equal identity");
    }
    ...
    void deserializeElementFromBytesSuccess(final Group group) {
        ...
        final GroupElement fromCompressedBytes =
                group.deserializeElementFromBytes(randomElementCompressed.toBytes());
        ...
        Assertions.assertEquals(
                fromCompressedBytes, fromUncompressedBytes, "Elements from bytes should be equal");
    }
    ...
    void divideCompressed(final Group group) {
        ...
        final GroupElement quotient = randomElement1.divide(randomElement2);
        final GroupElement quotientCompressed =
                randomElement1Compressed.divide(randomElement2Compressed);
    ...
    void divideFailure(final Group group) {
        final GroupElement randomElement =
                group.randomElement(TestUtils.randomByteArray(random, group.getSeedSize()));
        assertThrows(
                IllegalArgumentException.class,
                () -> randomElement.divide(null),
    ...
    void multiplyCompressed(final Group group) {
        ...
        final GroupElement product = randomElement1.multiply(randomElement2);
        final GroupElement productCompressed =
                randomElement1Compressed.multiply(randomElement2Compressed);
    ...
    void batchMultiplySuccess(final Group group) {
        ...
        final Collection<GroupElement> elements =
                Arrays.asList(randomElement1, randomElement2, identityElement);
    ...
    void batchMultiplyCompressed(final Group group) {
        ...
        final Collection<GroupElement> elements =
                Arrays.asList(randomElement1, randomElement2, randomElement3);

        final Collection<GroupElement> elementsCompressed =
                Arrays.asList(
                        randomElement1Compressed,
                        randomElement2Compressed,
                        randomElement3Compressed);
    ...
    void batchMultiplyCommutative(final Group group) {
        ...
        final GroupElement randomElement2 =
                group.randomElement(TestUtils.randomByteArray(random, group.getSeedSize()));
        final GroupElement randomElement3 =
                group.randomElement(TestUtils.randomByteArray(random, group.getSeedSize()));

        final Collection<GroupElement> elements1 =
                Arrays.asList(randomElement1, randomElement2, randomElement3);

        final Collection<GroupElement> elements2 =
                Arrays.asList(randomElement2, randomElement3, randomElement1);
        ...
        Assertions.assertEquals(
                product1,
                product2,
                "multiplication with same differently ordered batch inputs should produce same"
                        + " result");
    }
    ...
    void powerCompressed(final Group group) {
        ...
        final FieldElement randomScalar =
                field.randomElement(TestUtils.randomByteArray(random, group.getSeedSize()));
    ...
    void elementEqualsWrongGroup() {
        ...
        Assertions.assertNotEquals(
                group1Element,
                group2Element,
                "Elements of different groups should not equal one another");
    }
    ...
    void doubleCompression(final Group group) {
        final GroupElement doubleCompressedElement =
                group.randomElement(TestUtils.randomByteArray(random, group.getSeedSize()))
                        .compress()
                        .compress();
