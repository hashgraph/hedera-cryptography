...
public class BLS12381Group2Element implements GroupElement {
    ...
    public GroupElement power(final FieldElement exponent) {
        ...
        final int errorCode;
        if ((errorCode = BLS12381Bindings.g2PowZn(this, exponentElement, output)) != SUCCESS) {
    ...
    public GroupElement multiply(final GroupElement other) {
        ...
        final int errorCode;
        if ((errorCode = BLS12381Bindings.g2Multiply(this, otherElement, output)) != SUCCESS) {
    ...
    public GroupElement divide(final GroupElement other) {
        ...
        final int errorCode;
        if ((errorCode = BLS12381Bindings.g2Divide(this, otherElement, output)) != SUCCESS) {
    ...
    public GroupElement compress() {
        ...
        final int errorCode;
        if ((errorCode = BLS12381Bindings.g2Compress(this, newGroupElement)) != SUCCESS) {
