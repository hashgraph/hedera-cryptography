...
package com.hedera.cryptography.tss.impl.elgamal;
...
public record CiphertextTable(@NonNull List<GroupElement> sharedRandomness, @NonNull CipherText[] shareCiphertexts)
    ...
    public CombinedCiphertext combine() {
        final FieldElement base =
                sharedRandomness.getFirst().getGroup().field().fromLong(ElGamalUtils.TOTAL_NUMBER_OF_ELEMENTS);
