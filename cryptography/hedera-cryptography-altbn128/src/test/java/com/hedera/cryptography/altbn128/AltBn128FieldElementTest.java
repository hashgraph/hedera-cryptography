...
class AltBn128FieldElementTest {
    ...
    void fieldElementFromByteArrayAndBack() {
        ...
        final FieldElement element = field.fromBytes(originalArray);
        final byte[] secondArray = element.toBytes();
    ...
    void fieldElementToBigInteger() {
        ...
        assertArrayEquals(
                ...
                field.fromBytes(ByteArrayUtils.toLittleEndianBytes(rMinusOne)).toBytes());
        assertEquals(
                BigInteger.ZERO,
        ...
        assertEquals(
                BigInteger.ONE,
                field.fromBytes(ByteArrayUtils.toLittleEndianBytes(rPlusOne)).toBigInteger());
    }
