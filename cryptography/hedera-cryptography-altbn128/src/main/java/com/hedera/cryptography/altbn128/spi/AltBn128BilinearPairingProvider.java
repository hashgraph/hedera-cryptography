...
import com.hedera.cryptography.altbn128.AltBn128BilinearPairing;
...
/**
 * A {@link BilinearPairingProvider} implementation for {@link KnownCurves#ALT_BN128}.
 */
public class AltBn128BilinearPairingProvider extends BilinearPairingProvider {
    @Override
    ...
    public BilinearPairing pairing() {
        return new AltBn128BilinearPairing();
    }
}
