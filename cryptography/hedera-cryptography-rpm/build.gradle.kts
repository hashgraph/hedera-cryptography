...
tasks.withType<CargoBuildTask> {
    ...
    doLast {
        ...
        if (target.contains("windows")) {
            ...
            processBuilder.environment().put("SP1_GNARK_FFI_GO_ENVS", "CC=clang-cl;CCC_OVERRIDE_OPTIONS=x-dM x-fno-stack-protector x-fmessage-length=0 +-Wno-unused-macros +-Wno-unused-command-line-argument +-Wno-reserved-identifier +-fuse-ld=lld-link +/vctoolsdir +$xwinFolder/crt +/winsdkdir +$xwinFolder/sdk")
