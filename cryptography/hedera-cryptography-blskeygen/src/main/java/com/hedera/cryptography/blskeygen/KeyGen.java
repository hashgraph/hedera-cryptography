        ...
        switch (cliArguments.command()) {
            ...
            case GENERATE_KEYS -> {
                ...
                AsciiArmoredFiles.writeKey(
                        cliArguments.privateKeyPath(), BlsSerializers.privateKeySerializer(), keyPair.privateKey());
                AsciiArmoredFiles.writeKey(
                        cliArguments.publicKeyPath(), BlsSerializers.publicKeySerializer(), keyPair.publicKey());
                System.out.printf(
            ...
            case GENERATE_PUBLIC_KEY -> {
                ...
                final BlsPrivateKey privateKey = AsciiArmoredFiles.readPrivateKey(
                        cliArguments.privateKeyPath(), BlsDeserializers.privateKeyDeserializer(SIGNATURE_SCHEMA));
                final BlsPublicKey publicKey = privateKey.createPublicKey();
                AsciiArmoredFiles.writeKey(
                        cliArguments.publicKeyPath(), BlsSerializers.publicKeySerializer(), publicKey);
